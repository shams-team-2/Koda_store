    ...
    <header className="sticky top-0 z-50 bg-white dark:bg-gray-900 shadow-sm dark:border-b dark:border-gray-800">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <nav className="hidden md:flex items-center gap-1 bg-gray-100 dark:bg-gray-800 rounded-full px-2 py-1">
          {navLinks.map((link) => (
            <NavLink
              ...
              to={link.to}
              className={({ isActive }) =>
                `px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 ${isActive
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/cart"
            className="relative group w-9 h-9 flex items-center justify-center rounded-full border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800"
          >
