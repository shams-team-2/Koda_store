...
export default function Cart() {
  ...
  if (cartItems.length === 0) {
    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-6 bg-[#faffa]">
        ...
        <div className="col-span-8">
          <div className="bg-white rounded-3xl shadow-sm p-8">
            <ul className="space-y-6">
              {cartItems.map((item) => (
                <li
                  key={item.id}
                  className="flex justify-between items-center border-b border-gray-200 pb-6 last:border-none">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-red-50 text-red-500 hover:bg-red-100 transition duration-300 flex items-center gap-2">
          ...
          <div className="mt-6 bg-white rounded-3xl shadow-sm p-6">
            <h4 className="flex items-center gap-2 font-semibold mb-4">
              <FaTag className="text-indigo-600" /> Coupon Code
            </h4>
            <div className="flex gap-3">
              <input  type="text" placeholder="Enter code" className="flex-1 border rounded-lg px-4 py-2"/>
        ...
        <div className="col-span-4 bg-white rounded-3xl shadow-sm p-8">
          ...
          <div className="space-y-3 text-gray-700">
            ...
            <p className="flex justify-between">
              ...
              <span>
                EGP {shipping}{" "}
                {shipping === 0 && <span className="text-green-500 text-sm">(Free)</span>}
              </span>
            </p>
            <p className="text-gray-400 text-sm">Free shipping on orders over EGP 1,000</p>
            <p className="flex justify-between">
              <span>Tax (14%):</span>
          ...
          <div className="mt-6 space-y-3">
            ...
            <Link to="/shop" className="w-full flex items-center justify-center gap-2 bg-gray-200 text-gray-700 py-3 rounded-lg font-semibold hover:bg-gray-300 transition">
