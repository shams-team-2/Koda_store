  ...
  if (cartItems.length === 0) {
    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-6 bg-[#faffa] dark:bg-gray-900">
        <div className="w-20 h-20 rounded-full bg-indigo-50 dark:bg-indigo-900/40 flex items-center justify-center mb-6">
        ...
        <div className="col-span-8">
                ...
                <li
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-red-50 dark:bg-red-900/40 text-red-500 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/60 transition duration-300 flex items-center gap-2">
          ...
          <div className="mt-6 bg-white dark:bg-gray-800 rounded-3xl shadow-sm p-6">
            ...
            <div className="flex gap-3">
              <input  type="text" placeholder="Enter code" className="flex-1 border rounded-lg px-4 py-2 bg-white dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-400 dark:border-gray-600"/>
